...
export function Logo({ compact = false }: { compact?: boolean }) {
  return (
    <Link href="/" className="group inline-flex min-h-11 items-center gap-3" aria-label="عُهدة - الرئيسية">
      ...
      {!compact && (
        <span>
          <span className="block text-xl font-bold leading-5 text-ink">عُهدة</span>
